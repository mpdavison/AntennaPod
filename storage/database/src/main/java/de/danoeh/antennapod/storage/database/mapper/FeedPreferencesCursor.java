...
public class FeedPreferencesCursor extends CursorWrapper {
    ...
    private final int indexAdDetection;
    ...
    public FeedPreferencesCursor(Cursor cursor) {
        ...
        indexAdDetection = cursor.getColumnIndexOrThrow(PodDBAdapter.KEY_AD_DETECTION);
    ...
    public FeedPreferences getFeedPreferences() {
        ...
        return new FeedPreferences(
                ...
                FeedPreferences.AdDetectionSetting.fromCode(getInt(indexAdDetection)),
